...
export default function WhatWeOffer() {
  return (
    <section className="relative min-h-[400px] sm:min-h-[500px] md:min-h-[550px] lg:min-h-[600px] w-full">
      ...
      <div className="relative h-full container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-full flex flex-col items-center justify-center text-center py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-7xl">
            <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-5xl font-bold mb-4 sm:mb-6 text-white">
