...
export default function Support() {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      {/* Decorative Elements */}
      <div className="absolute top-0 left-0 w-64 h-64 bg-[#4CAF50]/5 rounded-full -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#4CAF50]/5 rounded-full translate-x-1/2 translate-y-1/2" />
      
      <div className="container mx-auto px-4 relative">
        <div className="max-w-7xl mx-auto">
          {/* Header with decorative line */}
          <div className="text-center mb-16 relative">
            <span className="text-[#4CAF50] font-semibold tracking-wide block mb-4">UNTERSTÜTZUNG</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Zuverlässige Hilfe für<br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-16">
            ...
            <div className="grid grid-cols-1 gap-8">
              {features.map((feature, index) => (
                <div 
                  key={index} 
                  className="bg-white rounded-xl p-8 shadow-lg flex items-start space-x-6 transform hover:scale-105 transition-transform duration-300"
                >
                  <div className="flex-shrink-0 bg-[#4CAF50]/10 p-4 rounded-full">
                    {feature.icon}
                  </div>
                  <div>
          ...
          <div className="relative">
            ...
            <div className="bg-gradient-to-r from-[#4CAF50]/10 to-[#4CAF50]/20 rounded-2xl p-8 lg:p-12 relative">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#4CAF50]/10 rounded-full translate-x-1/2 -translate-y-1/2" />
