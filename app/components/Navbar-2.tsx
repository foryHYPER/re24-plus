        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-3">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-blue-600 p-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="flex-1">
              <ul className="flex space-x-8 py-5">
                ...
                <li>
                  <Link href="/about" className="text-gray-700 hover:text-[#4CAF50] font-medium transition-colors px-2 py-3">
                    Über Uns
                  </Link>
                </li>
                <li>
                  <Link href="/services" className="text-gray-700 hover:text-[#4CAF50] font-medium transition-colors px-2 py-3">
                    Leistungen
                  </Link>
                </li>
                <li>
                  <Link href="/pricing" className="text-gray-700 hover:text-[#4CAF50] font-medium transition-colors px-2 py-3">
                    Preise
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-gray-700 hover:text-[#4CAF50] font-medium transition-colors px-2 py-3">
                    Kontakt
                  </Link>
                </li>
              </ul>
            ...
            <div className="flex items-center space-x-4">
              {/* Facebook */}
              <Link href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600 transition-colors">
              ...
              {/* Instagram */}
              <Link href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-pink-600 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
